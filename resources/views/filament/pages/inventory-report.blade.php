        ...
        <table style="width:100%;border-collapse:collapse;font-size:0.8125rem;">
            <thead>
                <tr style="background:#f3f4f6;">
                    ...
                    <th style="padding:0.5rem 0.75rem;border-bottom:1px solid #e5e7eb;text-align:end;">{{ __('resources.fields.market_cost') }}</th>
                    <th style="padding:0.5rem 0.75rem;border-bottom:1px solid #e5e7eb;text-align:end;">{{ __('resources.fields.market_value') }}</th>
            ...
            <tbody>
                @forelse ($this->getMaterials() as $m)
                    <tr style="border-bottom:1px solid #f3f4f6;{{ $m['is_low'] ? 'background:#fef2f2;' : '' }}">
                        ...
                        <td style="padding:0.45rem 0.75rem;text-align:end;color:#0369a1;">{{ number_format($m['market_cost'], 2) }}</td>
                        <td style="padding:0.45rem 0.75rem;text-align:end;font-weight:600;color:#0369a1;">{{ number_format($m['market_value'], 2) }}</td>
                ...
                @empty
                    <tr><td colspan="10" style="padding:1.5rem;text-align:center;color:#9ca3af;">{{ __('resources.pages.no_data') }}</td></tr>
                @endforelse
            </tbody>
        </table>
    </div>
