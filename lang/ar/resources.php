...
return [
    ...
    'fields' => [
        ...
        'market_cost'            => 'التكلفة السوقية',
        'actual_cost'            => 'التكلفة الفعلية',
        'market_value'           => 'القيمة السوقية',
        'actual_material_cost'   => 'تكلفة المواد الفعلية',
        'market_material_cost'   => 'تكلفة المواد السوقية',
        'actual_unit_cost'       => 'تكلفة الوحدة الفعلية',
        'market_unit_cost'       => 'تكلفة الوحدة السوقية',
        'total_market_cost'      => 'إجمالي التكلفة السوقية',
        'supplier'          => 'المورد',
        'number'            => 'الرقم',
        'status'            => 'الحالة',
