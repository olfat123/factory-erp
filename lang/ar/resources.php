...
return [
    ...
    'pages' => [
        ...
        'two_factor_enabled'     => 'تفعيل المصادقة الثنائية (2FA)',
        'two_factor_helper'      => 'عند التفعيل، يجب على المستخدمين التحقق من رمز مكون من 6 أرقام يُرسل إلى بريدهم الإلكتروني بعد كل تسجيل دخول.',
